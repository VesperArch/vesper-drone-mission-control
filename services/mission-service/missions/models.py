"""
Mission model for the mission-service microservice.
assigned_drone_id is a plain CharField — no cross-service FK to drone-service.
Drone data is fetched via HttpDroneRepository when needed.
"""
import uuid
...
class Mission(models.Model):
    ...
    # No FK — drone lives in drone-service, referenced by ID only
    assigned_drone_id = models.CharField(max_length=36, null=True, blank=True)
