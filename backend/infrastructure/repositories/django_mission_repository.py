...
class DjangoMissionRepository(MissionRepository):
    """
    Infrastructure: maps between MissionEntity (domain) and Mission (Django ORM).
    This is the ONLY place in the codebase allowed to import missions.models.
    """
    ...
    def _to_entity(m: Mission) -> MissionEntity:
        return MissionEntity(
            ...
            status=m.status,
            assigned_drone_id=str(m.assigned_drone_id) if m.assigned_drone_id else None,
